...
def webServer(port=13331):
  ...
  while True:
    ...
    try:
      ...
      serverSocket.sendmsg(connectionSocket, http_text, b"HTTP/1.1 200 OK\r\n")
      #Fill in end

      #Send the content of the requested file to the client
      for i in f: #for line in file
        serverSocket.sendmsg(connectionSocket, i) # #Fill in start - send your html file contents #Fill in end
    ...
    serverSocket.sendmsg(connectionSocket, http_text, b"HTTP/1.1 400 Not Found\r\n")
    #Fill in end
